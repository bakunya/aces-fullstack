...
export function BatchHTML({ children, js, css }: { js: string[], css: string[], children: JSX.Element }) {
	return (
		<html>
			<head>
				<title>Batch</title>
...
export function BatchHTMLHOC<T extends {} = {}>(Component: (props: T) => JSX.Element, { viteGenerated, css, js }: { viteGenerated?: string[], css?: string[], js?: string[] } = {}) {
	...
	return (props: T) => (
		<BatchHTML js={ jsFiles } css={ cssFiles }>
			<Component { ...props } />
		</BatchHTML>
	)
}