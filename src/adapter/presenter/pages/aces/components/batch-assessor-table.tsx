...
export function BatchAssessorTable({ assessors, batch_uuid }: Props) {
							...
							>
								...
								<div className="flex gap-2">	
									...
									<button 
										...
										hx-delete={route('delete.aces.hx.batch.batch_id.assessor.assessor_id.module_type', [batch_uuid, a.user_uuid, a.type.toLocaleLowerCase()])}
									>
	...
	: (
		<div class={ "w-full bg-gray-100 p-10 flex items-center justify-center rounded" }>
			<p>Klik <span class={ "text-gray-800 font-semibold" }>Tampilkan Data Assessor</span>, untuk mengalokasikan.</p>
		</div>
	)
}