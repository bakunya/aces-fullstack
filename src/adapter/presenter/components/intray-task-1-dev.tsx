...
export function IntrayTask1({ data }: TIntrayTask1Props) {
	return (
		<div className="my-10" id="intray-editor-dev">
			...
			<button 
				...
				hx-put={route("put.module.hx.dashboard.intray.id.dev.section.section_type", [data.mod_uuid, "intray_task_1"])}
				hx-swap="none"
