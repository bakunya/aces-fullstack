...
export type TIntrayIntroDevProps = {
	data: {
		id: number;
		mod_uuid: string;
		title: string;
...
export function IntrayIntroDev({ data }: TIntrayIntroDevProps) {
	return (
		<div className="my-10" id="intray-editor-dev">
			...
			<button 
				...
				hx-put={route("put.module.hx.dashboard.intray.id.dev.section.section_type", [data.mod_uuid, "intray_intro"])}
				hx-swap="none"
