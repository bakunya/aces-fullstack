...
export function IntrayTask3({ data }: TIntrayTask3Props) {
	return (
		<div className="my-10" id="intray-editor-dev">
			...
			<button 
				...
				hx-put={route("put.module.hx.dashboard.intray.id.dev.section.section_type", [data.mod_uuid, "intray_task_3"])}
				hx-swap="none"
