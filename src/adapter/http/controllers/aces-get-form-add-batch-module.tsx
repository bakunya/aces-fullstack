...
export async function acesGetFormAddBatchModuleController(c: Context) {
	...
	return c.html(<FormAddBatchModule batchId={ batchID } shouldShow={shouldShow} availableModulesObject={ availableModulesObject } batchInModulesObject={ batchInModulesObject }  />, 201)
}